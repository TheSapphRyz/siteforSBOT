...
| **img data** | **=**{{"t", 'i'}, {'i', id}, {"np", np}, {"vp", vp}, {'p', m} } | {{'t', 'i'}, {'s', 1}} | id - айди сообщения, np - номер текущего пакета, vp - количество пакетов, m - байты изображения в base64 | m в бд должен быть в шифровке, а не BLOB |
